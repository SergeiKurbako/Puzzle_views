                    ...
                    <div class="main__table--table main__table--table--request">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>{{$frame->url}}</td>
                                <td><a href="/gameframe/update-frame-status/{{$frame->id}}/?frame_status=on"><i class="fas fa-check-circle"></i></a>  <a href="/gameframe/delete/{{$frame->id}}"><i class="far fa-trash-alt"></i></a></td>
                                <td>
