...
namespace Modules\Games\Games\Mazes\EllerMaze2;
...
class GameDirector implements IGameDirector
{
    ...
    public function __construct()
    {
        ...
        $this->dataPool->addData('logicData', new \Modules\Games\Games\Mazes\EllerMaze2\Data\LogicData);
        $this->dataPool->addData('requestData', new \Modules\Games\Games\Mazes\EllerMaze2\Data\RequestData);
        ...
        $this->dataPool->addData('systemData', new \Modules\Games\Games\Mazes\EllerMaze2\Data\SystemData);
        ...
        $this->requestDataSetPool->addRequestData('open_game', new \Modules\Games\Games\Mazes\EllerMaze2\RequestDataSets\OpenGameRequestData);
        ...
        $this->workersPool->addWorker('responseWorker', new \Modules\Games\Games\Mazes\EllerMaze2\Workers\ResponseWorker);
        ...
        $this->instructionsPool->addInstruction('logicWorkerInstructions', 'loadData', new \Modules\Games\Games\Mazes\EllerMaze2\Instructions\WorkersInstructions\LogicWorkerInstructions\LogicWorkerLoadDataInstruction);
        ...
        $this->toolsPool->addTool('logicTools', 'firstMazeStringTool', new \Modules\Games\Games\Mazes\EllerMaze2\Tools\LogicTools\FirstMazeStringTool);
        $this->toolsPool->addTool('logicTools', 'otherMazeStringTool', new \Modules\Games\Games\Mazes\EllerMaze2\Tools\LogicTools\OtherMazeStringTool);
        $this->toolsPool->addTool('logicTools', 'lastMazeStringTool', new \Modules\Games\Games\Mazes\EllerMaze2\Tools\LogicTools\LastMazeStringTool);
        $this->toolsPool->addTool('logicTools', 'unionMazeStringsTool', new \Modules\Games\Games\Mazes\EllerMaze2\Tools\LogicTools\UnionMazeStringsTool);
        $this->toolsPool->addTool('logicTools', 'mazeStringTranscoderTool', new \Modules\Games\Games\Mazes\EllerMaze2\Tools\LogicTools\MazeStringTranscoderTool);

        // сбор действий
        $this->actionsPool = new \Avior\GameCore\Actions\ActionsPool;
        $this->actionsPool->addAction('open_game', new \Modules\Games\Games\Mazes\EllerMaze2\Actions\ActionOpenGame);
    }
