...
namespace Modules\Games\Games\Mazes\EllerMaze\Instructions\WorkersInstructions\LogicWorkerInstructions;
...
class LogicWorkerLoadDataInstruction implements IInstruction
{
    ...
    public function mazeGeneration(
        ...
        ->logicTools
        ->generatorTool
        ->generation($toolsPool, $width, $height);
        ...
        $dataPool->logicData->maze = $unionMazeStrings;
        return $dataPool;
    }
